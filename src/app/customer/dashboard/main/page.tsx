    ...
    <div className="dashboard">
      ...
      <section className='dashboard_main_block secondary_block'>
        <div className=" materialsManagementBlock ">
          ...
          <p className='secondary_heading'>There are no materials ordered yet by planner for your notification.</p>
        </div>
        <div className=" ordersManagementBlock ">
          <h2 className='primary_heading'>Orders Management</h2>
          <p className='secondary_heading'>There are no work orders created yet by planner for your notification.</p>
        </div>
      </section>
    </div>
  );
