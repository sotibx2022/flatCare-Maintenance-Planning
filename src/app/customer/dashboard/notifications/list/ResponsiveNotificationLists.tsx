...
const ResponsiveNotificationLists = () => {
    ...
    return (
        <>
            {isDeleting || isFetching ? <LoadingComponent /> :
                <div className=" flex flex-wrap w-full justify-between gap-4">
                    ...
                    {filteredNotifications && filteredNotifications.slice(startIndex, endIndex).map((notification: Notification, index: number) => (
                        <div key={index} className=" min-w-[300px] justify-between">
                            <div className="">
                                <div className="flex justify-between items-center border-t-[1px] border-b-[1px] border-helper">
                                    <span className="text-primaryDark">{startIndex + index + 1}.</span>
                                    <div className="">
                                        <span
                                            onClick={() => {
                                                router.push(
