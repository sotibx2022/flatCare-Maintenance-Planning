...
const LocationDetails: React.FC<LocationDetailsProps> = ({
  ...
  const [currentBuildingNumber, setCurrentBuildingNumber] = useState<string>(
    buildingNumber || '',
  );
  const [currentFloorNumber, setCurrentFloorNumber] = useState<string>(
    floorNumber || '',
  );
  ...
  const handleNext = () => {
    const next: number = 4; // Next step value
    locationDetailsValues(
  ...
  const handlePrev = () => {
    const next: number = 2; // Previous step value
    locationDetailsValues(
      currentBuildingNumber,
      currentFloorNumber,
      currentRoomNumber,
    ...
    <div className="container">
      <div className="stepInputs_Wrapper">
        <div className="form_Item">
          ...
          {errors.buildingNumber && focus.buildingNumber && (
            <SubmitError message={errors.buildingNumber} />
          )}
        </div>
        <div className="form_Item">
          ...
          {errors.floorNumber && focus.floorNumber && (
            <SubmitError message={errors.floorNumber} />
          )}
        </div>
        <div className="form_Item">
          ...
          {errors.roomNumber && focus.roomNumber && (
            <SubmitError message={errors.roomNumber} />
          )}
        </div>
        <div
