...
const SoftwareAccess: React.FC<SoftwareAccessProps> = ({
  softwareAccessValue,
  customerDatas,
}) => {
  ...
  const [currentConfirmPassword, setConfirmCurrentPassword] = useState(
    confirmPassword || '',
  );
      ...
      <div className="stepInputs_Wrapper">
        <div className="form_Item">
          ...
          {errors.email && focus.email && (
            <SubmitError message={errors.email} />
          )}
        </div>
        <div className="form_Item">
          ...
          {errors.password && focus.password && (
            <SubmitError message={errors.password} />
          )}
        </div>
        <div className="form_Item">
          ...
          {errors.confirmPassword && focus.confirmPassword && (
            <SubmitError message={errors.confirmPassword} />
          )}
        </div>
        <div
